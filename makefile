...
${ORBITALSIM_EXE}: ${MAIN_OBJ} ${LAUNCHOPTIONS_OBJ} ${ORBITALSIM_OBJ} ${VIEW_OBJ} ${EPHEMERIDES_OBJ} ${NMATH_OBJ}
	${CC} ${CFLAGS} -o ${ORBITALSIM_EXE} ${MAIN_OBJ} ${LAUNCHOPTIONS_OBJ} ${ORBITALSIM_OBJ} ${VIEW_OBJ} ${EPHEMERIDES_OBJ} ${NMATH_OBJ} ${LDFLAGS}
